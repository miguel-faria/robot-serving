...
class BaxterConnection(object):
    ...
    def __init__(self):
        ...
        self._start_trajectory_service = rospy.Service('start_trajectory', RobotMovementSendTrajectory,
                                                       self.handle_trajectory_start)
        self._movement_feedback_service = rospy.Service('movement_feedback', RobotMovementFeedback,
                                                        self.handle_trajectory_feedback)
        self._stop_start_trajectory_service = rospy.Service('stop_start_trajectory', RobotMovementCancelTrajectory,
