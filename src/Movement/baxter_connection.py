...
def handle_trajectory_start(req):
    traj = baxter_arm_control[req.limb]
...
def baxter_connection_service():
    ...
    baxter_arm_control = {'left': Trajectory('left'), 'right': Trajectory('right')}
    start_trajectory_service = rospy.Service('start_trajectory', RobotMovementSendTrajectory, handle_trajectory_start)
    movement_feedback_service = rospy.Service('movement_feedback', RobotMovementFeedback, handle_trajectory_feedback)
    stop_start_trajectory_service = rospy.Service('stop_start_trajectory', RobotMovementCancelTrajectory,
